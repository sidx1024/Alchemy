...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["selects"] = factory();
	else
		root["mdc"] = root["mdc"] || {}, root["mdc"]["selects"] = factory();
})(this, function() {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MDCSelects", function() { return MDCSelects; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MDCSelectsFoundation", function() { return __WEBPACK_IMPORTED_MODULE_3__foundation__["a"]; });
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var MDCSelects = function (_MDCComponent) {
  _inherits(MDCSelects, _MDCComponent);

  function MDCSelects() {
    _classCallCheck(this, MDCSelects);

    return _possibleConstructorReturn(this, (MDCSelects.__proto__ || Object.getPrototypeOf(MDCSelects)).apply(this, arguments));
  }

  _createClass(MDCSelects, [{
    key: 'item',
...
var MDCSelectsFoundation = function (_MDCFoundation) {
  _inherits(MDCSelectsFoundation, _MDCFoundation);

  _createClass(MDCSelectsFoundation, null, [{
    key: 'cssClasses',
    get: function get() {
  ...
  function MDCSelectsFoundation(adapter) {
    _classCallCheck(this, MDCSelectsFoundation);

    var _this = _possibleConstructorReturn(this, (MDCSelectsFoundation.__proto__ || Object.getPrototypeOf(MDCSelectsFoundation)).call(this, _extends(MDCSelectsFoundation.defaultAdapter, adapter)));
  ...
  _createClass(MDCSelectsFoundation, [{
    key: 'init',
    value: function init() {
    ...
    value: function setDisabled(disabled) {
      var DISABLED = MDCSelectsFoundation.cssClasses.DISABLED;
    ...
    value: function open_() {
      ...
      this.disableScroll_();
      var OPEN = MDCSelectsFoundation.cssClasses.OPEN;
  ...
  return MDCSelectsFoundation;
}(__WEBPACK_IMPORTED_MODULE_0__material_base_index__["MDCFoundation"]);

/* harmony default export */ __webpack_exports__["a"] = (MDCSelectsFoundation);
...
var strings = {
  CHANGE_EVENT: 'MDCSelects:change',
